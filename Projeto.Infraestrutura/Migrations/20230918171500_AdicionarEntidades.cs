        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodCID = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DataDiagnostico = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroConselho = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CIDsId = table.Column<int>(type: "int", nullable: false),
                    DiagnosticosId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CIDDiagnostico", x => new { x.CIDsId, x.DiagnosticosId });
                    table.ForeignKey(
                        name: "FK_CIDDiagnostico_CIDs_CIDsId",
                        column: x => x.CIDsId,
                        principalTable: "CIDs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CIDDiagnostico_Diagnosticos_DiagnosticosId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroFone = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroCarteira = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PesoPaciente = table.Column<double>(type: "float", nullable: true),
                    AlturaPaciente = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CIDDiagnostico_DiagnosticosId",
                table: "CIDDiagnostico",
